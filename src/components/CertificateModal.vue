...
<template>
  <Transition name="modal">
    <div
      ...
      <div
        class="modal-content relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
        <!-- Close Button -->
        <button
          @click="emit('close')"
          class="absolute top-3 right-3 z-10 p-1.5 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
        ...
        <div class="p-4 md:p-6">
          <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div
              ...
              class="lg:flex-1 flex items-center justify-center">
              <div
